...
function JoinFormModal({ onJoin, onClose }) {
        ...
        <div className="bg-white pt-1 rounded-xl shadow-custom01 w-80 h-80">
                ...
                <div className="flex justify-end mb-1">
                    <button onClick={handleClose} className="p-2">
                        <img src="images/ico/close.png" alt="Close" className="h-4 w-4" />
                    </button>
                </div>
                {/* 폼 제목 */}
                <div className="text-2xl font-bold text-center text-shadow-custom01 mb-5">회원가입</div>
                {/* 입력 필드 */}
                <div className="mb-3 px-6">
                    ...
                    <div className="flex items-center justify-start mb-3">
                        <input type="checkbox" id="agree" className="mr-2" onChange={handleCheckboxChange} />
                        <label htmlFor="agree" className="text-xs">이메일 수신 동의</label>
                    </div>
                    <input
                        type="password"
                        placeholder="비밀번호"
